...
import { withCompanyViewModel } from '../CompanyViewModel/CompanyViewModelContextProvider';
  ...
  return (
    <>
      <div className="d-flex justify-content-between align-items-start mb-3">
        <div>
          <h2 className="fw-bold mb-1">{t('txt_list_company')}</h2>
        </div>
        <ActionsBar
          buttons={[
            {
      ...
      <Tabs
        ...
        className="mb-3"
      >
        <Tab eventKey={'default'} title={t('txt_all_company')} />
